...
class DatabaseTables
{
    ...
    /**
     * Create custom table for storing post changes
     * @since 1.8.0
     */
    public function createPostChangesTable()
    {
        global $wpdb;
    ...
    // Create the table
    $post_changes_sql = "CREATE TABLE {$tablename} (
        id bigint(20) NOT NULL AUTO_INCREMENT,
        post_id bigint(20) UNSIGNED NOT NULL,
        post_title text NOT NULL,
        post_type varchar(255) NOT NULL,
        action varchar(20) NOT NULL,
        needs_transfer tinyint(1) NOT NULL DEFAULT '0',  -- New column for needs transfer
