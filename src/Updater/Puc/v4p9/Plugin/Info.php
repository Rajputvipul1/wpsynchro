<?php
if ( !class_exists('WPSynchroPuc_v4p9_Plugin_Info', false) ):
	 ...
	 * @access public
	 */
	class WPSynchroPuc_v4p9_Plugin_Info extends WPSynchroPuc_v4p9_Metadata {
